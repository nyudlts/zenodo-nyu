...
Install the OpenShift `oc` client: https://docs.openshift.org/latest/cli_reference/get_started_cli.html.
...
You think, you code, you refactor, you test, you test, you test... and now you want to deploy!
